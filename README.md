...
Atentados en Transnistria. En estos momentos, la población de Ucrania se enfrenta 
...
alfabeto que está determinado permite traducir también comunicaciones en 
...
entre otros podrán hacerlo y coordinarse sin miedo.
...
El usuario decide qué función requiere ya sea enviar un mensaje encriptado o al 
recibir un mensaje encriptado descifrarlo solo debe ingresar el texto seleccionar 
la contraseña que es el número de posiciones, y presionar el botón inmediatamente 
se revelara el mensaje.
...
solicitando el “nombre” al usuario y dar un pequeño saludo, pero claramente no es obligatorio 
ni necesario que sea el nombre real por temas de que la información es secreta.
